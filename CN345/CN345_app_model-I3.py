...
model_TL.compile(optimizer=RMSprop(lr=0.0001), loss='binary_crossentropy', metrics=['accuracy'])
...
tf.keras.models.save_model(model_TL,'Auntie-DOT_I3.hdf5') #will be save as this file
